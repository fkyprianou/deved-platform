  ...
  <div>
    ...
    <main class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
      ...
      <section class="index-section">
        ...
        >
          <p class="mb-2">
            <b> Please note that our team is currently at full capacity and we regret to inform you 
            that we are unable to accept any new submissions at this time. <br> However, we are actively 
            planning to reopen our submission process in the near future. Please stay tuned for updates and announcements. <br>
            Thank you for your understanding and patience.</b>
          </p>
