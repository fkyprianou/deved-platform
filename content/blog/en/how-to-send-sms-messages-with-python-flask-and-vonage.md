...
updated_at: 2023-02-24T17:56:56.257Z
category: tutorial
tags:
  - puthon
  - flask
...
In this tutorial, we will send an SMS using CLI and Flask application. Prepared a simple code sample will be an excellent point to start and create your application quickly.
...
Run REPL, Python language shell
...
Created a Vonage Client object that can be re-used and knows your Vonage API key and its secret.
...
Check your smartphone notification, and you should receive an SMS message. If not, check the contents of the response.

![SMS screenshot](/content/blog/how-to-send-sms-messages-with-python-flask-and-vonage/sms-screenshot.png)

You can monitor and troubleshoot SMS delivery [here](https://dashboard.nexmo.com/sms/delivery/by-day)
...
For deploy the application you can also clone repo using [git](https://git-scm.com/downloads) and update `.env` with your credentials
